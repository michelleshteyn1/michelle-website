...
\position{Researcher and Analyst}
\address{Department of Psychological \& Brain Sciences, UC Santa Barbara}

\mobile{973 641 6454}
\email{\href{mailto:michelleshteyn@gmail.com}{\nolinkurl{michelleshteyn@gmail.com}}}
\homepage{michelleshteynhandy.com}
...
\makecvfooter
  {February 2021}
    {Michelle Handy~~~·~~~Curriculum Vitae}
  {\thepage}
...
1. O'Hara-Wild, M., \& Hyndman, R. (2021). \emph{Vitae: Curriculum vitae
for r markdown}. \url{https://CRAN.R-project.org/package=vitae}

\leavevmode\hypertarget{ref-R-tibble}{}%
2. Müller, K., \& Wickham, H. (2020). \emph{Tibble: Simple data frames}.
