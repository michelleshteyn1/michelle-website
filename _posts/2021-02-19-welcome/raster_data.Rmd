...
geom_raster(data = species_richness1_df, aes(x=x,y=y, fill = layer)) +
  ...
  labs(x = "", y = "", title = "Map of Cetacean Species Richness off the California Coast" )
