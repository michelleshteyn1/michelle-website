---
title: "Spatial Data Visualization: California Oil Spill"
description: |
...
These data are measurements for oil spill incidents, where an incident refers to "a discharge or threatened discharge of petroleum or other deleterious material into the waters of the state" (OSPR). Here, I read in the layer with `read_sf()`, check the CRS, then make a quick plot to start.
